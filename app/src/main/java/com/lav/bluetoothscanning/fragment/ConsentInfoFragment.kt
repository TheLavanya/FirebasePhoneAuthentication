...
import kotlinx.android.synthetic.main.fragment_consent_info.*

class ConsentInfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        initViewModel()
        return inflater.inflate(R.layout.fragment_consent_info, container, false)
    }
